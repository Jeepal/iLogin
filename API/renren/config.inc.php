...
$config->APPID		= variable_get('renren_key', '');	//你的API Key，请自行申请
$config->APIKey		= variable_get('renren_key', '');	//你的API Key，请自行申请
$config->SecretKey	= variable_get('renren_secret', '');	//你的API 密钥
$config->APIVersion	= '1.0';	//当前API的版本号，不需要修改
$config->decodeFormat	= 'json';	//默认的返回格式，根据实际情况修改，支持：json,xml

$config->redirecturi= $GLOBALS['_ILOGIN']->callbacks['renren'];//你的获取code的回调地址，也是accesstoken的回调地址
